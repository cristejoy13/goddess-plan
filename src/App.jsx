...
const SEARCH_INDEX = [
  // The week runs Thursday → Wednesday, and search follows it in that order.
  { label: 'Thursday — Glute Power', hint: 'Workouts · Zone 2 Run · Hip Thrust · RDL · Step-Up', section: 'workout', scrollTo: 'day-thursday'  },
  { label: 'Friday — Abs & Upper Body', hint: 'Workouts · Zone 2 Run · 5 ab moves · Shoulders · Back', section: 'workout', scrollTo: 'day-friday'    },
  { label: 'Saturday — Run & Jessica Diem', hint: 'Workouts · Easy Run · Jessica Diem video · Forearm Stand', section: 'workout', scrollTo: 'day-saturday'  },
  { label: 'Sunday — Sprints & Jessica Diem', hint: 'Workouts · Sprint Intervals · Jessica Diem video · Forearm Stand', section: 'workout', scrollTo: 'day-sunday'  },
  { label: 'Monday — Glute Strength', hint: 'Workouts · Zone 2 Run · Squat · Bulgarian · RDL', section: 'workout', scrollTo: 'day-monday'    },
  { label: 'Tuesday — Abs & Upper Body', hint: 'Workouts · Zone 2 Run · 5 ab moves · Shoulders · Back', section: 'workout', scrollTo: 'day-tuesday'   },
  { label: 'Wednesday — Glute Shape', hint: 'Workouts · Zone 2 Run · Abduction · Kickback · Sumo · short abs', section: 'workout', scrollTo: 'day-wednesday' },

  // The six glute lifts everything is built on.
  { label: 'Barbell Hip Thrust',      hint: 'Workouts → Thursday Glute Power · the best glute builder', section: 'workout', scrollTo: 'day-thursday' },
  { label: 'Romanian Deadlift (RDL)', hint: 'Workouts → Thursday & Monday', section: 'workout', scrollTo: 'day-thursday' },
  { label: 'Dumbbell Step-Up',        hint: 'Workouts → Thursday Glute Power', section: 'workout', scrollTo: 'day-thursday' },
  { label: 'Barbell Back Squat',      hint: 'Workouts → Monday Glute Strength', section: 'workout', scrollTo: 'day-monday'   },
  { label: 'Bulgarian Split Squat',   hint: 'Workouts → Monday Glute Strength · evens out the hips', section: 'workout', scrollTo: 'day-monday'   },
  { label: 'Hip Abduction',           hint: 'Workouts → Wednesday Glute Shape · the round upper-side glute', section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Cable Kickback',          hint: 'Workouts → Wednesday Glute Shape', section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Sumo Squat',              hint: 'Workouts → Wednesday Glute Shape', section: 'workout', scrollTo: 'day-wednesday' },

  // Abs — Friday and Tuesday in full, a short third hit on Wednesday.
  { label: 'Abs — the five moves', hint: 'Workouts → Friday & Tuesday · crunch, reverse crunch, leg raise, dead bug, plank', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Weighted Crunch',         hint: 'Workouts → Friday & Tuesday · the only ab move that gets heavier', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Reverse Crunch',          hint: 'Workouts → Friday, Tuesday & Wednesday · lower stomach', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Lying Leg Raise',         hint: 'Workouts → Friday & Tuesday · lower stomach', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Dead Bug',                hint: 'Workouts → Friday, Tuesday & Wednesday · deep core', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Plank',                   hint: 'Workouts → Friday, Tuesday & Wednesday', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Stomach Vacuum',          hint: 'Workouts → Friday & Tuesday · warm-up · pulls the waist in', section: 'workout', scrollTo: 'day-friday' },

  // Upper body — kept light on purpose.
  { label: 'Band Pull-Apart',         hint: 'Workouts → Friday & Tuesday · posture, not size', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Double-Arm Dumbbell Row', hint: 'Workouts → Friday & Tuesday · back', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Incline Push-Up',         hint: 'Workouts → Friday & Tuesday · slim, toned arms', section: 'workout', scrollTo: 'day-friday' },

  { label: 'Jessica Diem — weekend videos', hint: 'Workouts → Saturday & Sunday · one video each day', section: 'workout', scrollTo: 'day-saturday' },
  { label: 'Abs Videos — Pilates by Izzy', hint: 'Workouts → Friday & Tuesday · optional extra', section: 'workout', scrollTo: 'day-friday' },
  ...
  { label: 'Meal Times — the daily clock',     hint: 'Nutrition → Daily Clock · coffee & banana, protein & kimchi, 3 PM bowl, 5 PM apple sticks', section: 'nutrition', tab: 'daily' },
  { label: 'Zone 2 Run — 20 min before training', hint: 'Workouts → every weekday, before the main workout', section: 'workout', scrollTo: 'day-thursday' },
  { label: 'Protein — 50 g a day is the floor', hint: 'Nutrition → Daily Clock · the one number to watch', section: 'nutrition', tab: 'daily' },
  ...
  { label: 'Protein Smoothie Bowl — 3 PM',    hint: 'Nutrition → Daily Clock · 2–3 frozen fruits, a scoop of protein, granola, chia', section: 'nutrition', tab: 'daily' },
