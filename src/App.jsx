...
const SEARCH_INDEX = [
  ...
  { label: 'Tuesday — Pilates',   hint: 'Workouts · Deep Core & Posture',        section: 'workout', scrollTo: 'day-tuesday'   },
  { label: 'Wednesday — Pilates', hint: 'Workouts · Full Body & Lats',           section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Thursday — Glute B',          hint: 'Workouts · Sumo · Kickback · Abduction',    section: 'workout', scrollTo: 'day-thursday'  },
  { label: 'Friday — Pilates',    hint: 'Workouts · Core & Alignment',           section: 'workout', scrollTo: 'day-friday'    },
  { label: 'Saturday — Pilates',  hint: 'Workouts · Full Body Flow',             section: 'workout', scrollTo: 'day-saturday'  },
  { label: 'Sunday — Pilates',    hint: 'Workouts · Balance & Inversions',       section: 'workout', scrollTo: 'day-sunday'    },
  ...
  { label: 'Everyday Meals — OMAD',            hint: 'Nutrition → Everyday Meals',     section: 'nutrition', tab: 'light' },
