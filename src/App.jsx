...
const SEARCH_INDEX = [
  ...
  { label: 'Sumo Squat',              hint: 'Workouts → Wednesday Glute B',  section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Cable Kickback',          hint: 'Workouts → Wednesday Glute B',  section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Kas Glute Bridge',        hint: 'Workouts → Friday Glute C',     section: 'workout', scrollTo: 'day-friday'    },
