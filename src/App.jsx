...
const SEARCH_INDEX = [
  { label: 'Monday — Glutes & Quads', hint: 'Workouts · Zone 2 Run · Squat · Bulgarian · RDL', section: 'workout', scrollTo: 'day-monday'    },
  { label: 'Tuesday — Back, Shoulders & Core',  hint: 'Workouts · Zone 2 Run · Pull-Apart · Row · Core · Rope or Walk', section: 'workout', scrollTo: 'day-tuesday'   },
  { label: 'Wednesday — Glute Isolation', hint: 'Workouts · Zone 2 Run · Kickback · Abduction · Sumo Squat', section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Thursday — Back, Shoulders & Core', hint: 'Workouts · Zone 2 Run · Pull-Apart · Row · Core · Rope or Walk', section: 'workout', scrollTo: 'day-thursday'  },
  { label: 'Friday — Glutes & Hamstrings', hint: 'Workouts · Zone 2 Run · Hip Thrust · RDL · Squat', section: 'workout', scrollTo: 'day-friday'    },
  ...
  { label: 'Zone 2 Run — 20 min before training', hint: 'Workouts → Monday to Friday, before the main workout', section: 'workout', scrollTo: 'day-monday' },
  { label: 'Apple Sticks & Yogurt',            hint: 'Nutrition → Daily Clock · the 5 PM meal', section: 'nutrition', tab: 'daily' },
  { label: 'Kimchi — after training',          hint: 'Nutrition → Daily Clock · protein & kimchi', section: 'nutrition', tab: 'daily' },
  { label: 'Smoothie & Granola Bowl — 3 PM',   hint: 'Nutrition → Daily Clock · 2–3 frozen fruits, granola, chia', section: 'nutrition', tab: 'daily' },
