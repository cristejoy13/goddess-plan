...
const SEARCH_INDEX = [
  ...
  { label: 'Monday — Glute Power', hint: 'Workouts · Zone 2 Run · Hip Thrust · RDL · Step-Up', section: 'workout', scrollTo: 'day-monday'    },
  ...
  { label: 'THE BIG MEAL — 2 PM', hint: 'Nutrition → Daily Clock · fish or eggs, sweet potato, yogurt, banana', section: 'nutrition', tab: 'daily' },
  { label: 'Eating window — 8 AM to 2 PM', hint: 'Nutrition → Daily Clock · nothing after 2 PM but tea', section: 'nutrition', tab: 'daily' },
  { label: 'Apple Sticks & Greek Yogurt',      hint: 'Nutrition → Daily Clock · the 11 AM meal · 16 g protein', section: 'nutrition', tab: 'daily' },
  { label: 'Kimchi — after training',          hint: 'Nutrition → Daily Clock · protein & kimchi', section: 'nutrition', tab: 'daily' },
  { label: 'Protein Smoothie Bowl — 8 AM',    hint: 'Nutrition → the big bowl that replaces BOTH small meals', section: 'nutrition', tab: 'daily' },
