...
const SEARCH_INDEX = [
  ...
  { label: 'Hair Routine — before the shower', hint: 'Body → Hair · comb, massage, oil, then wash', section: 'skincare', tab: 'hair' },
  { label: 'Hair Routine — after the shower',  hint: 'Body → Hair · growth serum, hydrating serum, heat protectant', section: 'skincare', tab: 'hair' },
  { label: 'Hair Routine — before sleep',      hint: 'Body → Hair · scalp oil, ends, lash serum, bonnet', section: 'skincare', tab: 'hair' },
  { label: 'Hair Routine — going out',         hint: 'Body → Hair · not greasy, not dry', section: 'skincare', tab: 'hair' },
  { label: 'Lash Serum — every night',         hint: 'Body → Hair → Before sleep · upper lash line only', section: 'skincare', tab: 'hair' },
  { label: 'Heat Protectant',                  hint: 'Body → Hair → After the shower · never heat without it', section: 'skincare', tab: 'hair' },
  { label: 'Hair Growth Serum — caffeine & peptides', hint: 'Body → Hair → After the shower · for the hairline', section: 'skincare', tab: 'hair' },
  ...
  { label: 'Satin Bonnet — during sleep',      hint: 'Body → Hair → Before sleep · keeps the oil in, stops the friction', section: 'skincare', tab: 'hair' },
  { label: 'Weekly Oil Soak — 4-week rotation', hint: 'Body → Hair · Sundays · rosemary mixed with a different oil each week', section: 'skincare', tab: 'hair' },
  { label: 'Peppermint Oil — Circulation week', hint: 'Body → Hair · one drop, once a month', section: 'skincare', tab: 'hair' },
