    ...
    <div className="hero hero-dashboard">
      ...
      <div className="hero-pfbs hero-baby-steps splash-item">
        ...
        <div className="hero-rules">
          ...
          <div className="hero-rule"><span>🏋️</span><span>5 strength days: glutes &amp; quads · glute isolation · glutes &amp; hamstrings · 2 upper-body days + jump rope · a 20-min walk every day</span></div>
