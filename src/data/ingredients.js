...
export const INGREDIENT_RECIPES = {
  ...
  salad: {
    ...
    tagline: 'Three anti-bloat salad builds — pick your favourite',
    options: [
      {
        name: 'Goddess Salad',
        emoji: '🌸',
        ...
        steps: [
          ...
          'Tear a handful of fresh pechay into pieces.',
          'Halve 5–6 cherry tomatoes.',
          'Dressing: squeeze 1–2 calamansi + ½ tsp olive oil + pinch of salt. Whisk.',
          'Toss everything together and serve immediately.',
        ],
        tip: 'The calamansi dressing acts as a digestive enzyme — it actively reduces bloating when eaten before protein.',
      },
      {
        name: 'Warm Anti-Inflammatory',
        emoji: '♨️',
        time: '8 min',
        steps: [
          'Steam pechay leaves for 2 min — just wilted, not mushy.',
          'Slice ½ cucumber.',
          'Dressing: 1 tsp fresh ginger (grated) + squeeze of calamansi + tiny drizzle olive oil.',
          'Arrange warm pechay and cucumber on a plate.',
          'Drizzle dressing over the top while still warm.',
        ],
        tip: 'Warm ginger activates digestion faster than cold salads. Best eaten with your protein meals.',
      },
      {
        name: 'Malunggay Detox',
        emoji: '🌿',
        time: '6 min',
        steps: [
          'Strip malunggay (moringa) leaves from stems — about 1 handful.',
          'Slice ½ cucumber.',
          'Cut 1 kiwi into small cubes.',
          'Dressing: squeeze calamansi + very thin slice of fresh ginger, muddled + pinch of salt.',
          'Toss all ingredients lightly and serve fresh.',
        ],
        tip: 'Malunggay is one of the most nutrient-dense greens in the Philippines — more iron than spinach, more Vitamin C than oranges.',
      },
    ],
  },
