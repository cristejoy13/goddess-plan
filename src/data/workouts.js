...
// Recommended meals — simple, oil-free, no-salt, low-calorie, and built ONLY
// from the ingredients the user eats. Fish means sardines with rice only.
// Proteins: sardines, chicken, egg / egg whites, or Greek yogurt. Carbs (rice,
// sweet potato) come with fibre; a little good fat sometimes (avocado, chia).
// Meals are grouped by protein so the plan reads clean and organised.
export const MEAL_TAGS = ['All', 'Sardines', 'Chicken', 'Egg', 'Greek yogurt', 'Fruit'];

export const RECOMMENDED_MEALS = [
  // ── Sardines (only with rice) ──
  { emoji: '🐟', name: 'Sardines & Rice', tag: 'Sardines', cal: 330,
    ingredients: 'Sardines · rice',
    steps: 'Cook the rice. Drain the sardines and serve over the rice. No oil, no salt.' },
  { emoji: '🐟', name: 'Sardines, Rice & Tomato', tag: 'Sardines', cal: 350,
    ingredients: 'Sardines · rice · tomatoes',
    steps: 'Cook the rice. Drain the sardines, add chopped tomato, and serve over the rice. No oil, no salt.' },
  { emoji: '🐟', name: 'Sardines, Rice & Bell Pepper', tag: 'Sardines', cal: 350,
    ingredients: 'Sardines · rice · bell pepper',
    steps: 'Cook the rice. Drain the sardines, add sliced bell pepper, and serve over the rice. No oil, no salt.' },
  { emoji: '🐟', name: 'Sardines Rice Bowl', tag: 'Sardines', cal: 360,
    ingredients: 'Sardines · rice · tomatoes · cucumber',
    steps: 'Cook the rice. Top with drained sardines, chopped tomato, and cucumber. No oil, no salt.' },

  // ── Chicken ──
  { emoji: '🍗', name: 'Chicken & Rice', tag: 'Chicken', cal: 380,
    ingredients: 'Chicken · rice · tomatoes',
    steps: 'Boil the chicken until cooked through. Cook the rice. Serve with chopped tomato. No oil, no salt.' },
  { emoji: '🍗', name: 'Chicken, Rice & Bell Pepper', tag: 'Chicken', cal: 380,
    ingredients: 'Chicken · rice · bell pepper',
    steps: 'Boil the chicken. Cook the rice. Add sliced bell pepper. No oil, no salt.' },
  { emoji: '🍗', name: 'Chicken & Sweet Potato', tag: 'Chicken', cal: 360,
    ingredients: 'Chicken · sweet potato · tomatoes',
    steps: 'Boil the chicken. Boil or steam the sweet potato. Serve with chopped tomato. No oil, no salt.' },
  { emoji: '🍗', name: 'Chicken & Bell Pepper Bowl', tag: 'Chicken', cal: 280,
    ingredients: 'Chicken · bell pepper · tomatoes · cucumber',
    steps: 'Boil the chicken and slice. Add bell pepper, tomato, and cucumber. Fresh and light. No oil, no salt.' },
  { emoji: '🍗', name: 'Chicken & Pineapple', tag: 'Chicken', cal: 320,
    ingredients: 'Chicken · pineapple',
    steps: 'Boil the chicken until cooked through. Serve with fresh pineapple slices. No oil, no salt.' },

  // ── Egg / egg whites ──
  { emoji: '🍠', name: 'Sweet Potato & Egg', tag: 'Egg', cal: 280,
    ingredients: 'Sweet potato · 1–2 eggs',
    steps: 'Boil or steam the sweet potato. Boil the egg 7–10 min. No oil, no salt.' },
  { emoji: '🥚', name: 'Egg Whites & Sweet Potato', tag: 'Egg', cal: 230,
    ingredients: '3 egg whites · sweet potato · tomatoes',
    steps: 'Boil or poach the egg whites. Boil the sweet potato. Serve with chopped tomato. No oil, no salt.' },
  { emoji: '🥚', name: 'Egg Whites & Rice', tag: 'Egg', cal: 260,
    ingredients: '3 egg whites · rice · tomatoes',
    steps: 'Boil or poach the egg whites. Cook the rice. Serve with chopped tomato. No oil, no salt.' },
  { emoji: '🥚', name: 'Egg White Scramble', tag: 'Egg', cal: 150,
    ingredients: '3 egg whites · bell pepper · tomatoes',
    steps: 'Scramble the egg whites in a non-stick pan (no oil) with chopped bell pepper and tomato. No salt.' },
  { emoji: '🥚', name: 'Egg Whites & Avocado', tag: 'Egg', cal: 220,
    ingredients: '3 egg whites · ¼ avocado · tomatoes',
    steps: 'Boil or poach the egg whites. Add ¼ sliced avocado and tomato. A little good fat. No oil, no salt.' },

  // ── Greek yogurt ──
  { emoji: '🥣', name: 'Greek Yogurt & Berries', tag: 'Greek yogurt', cal: 250,
  ...
  { emoji: '🥣', name: 'Greek Yogurt, Banana & Chia', tag: 'Greek yogurt', cal: 280,
    ingredients: 'Greek yogurt · banana · chia seeds',
    steps: 'Slice banana over the yogurt, sprinkle chia seeds. Let sit 5 min so the chia softens.' },
  { emoji: '🥣', name: 'Greek Yogurt & Kiwi', tag: 'Greek yogurt', cal: 230,
    ingredients: 'Greek yogurt · kiwi · berries',
    steps: 'Top the yogurt with sliced kiwi and berries. Fresh, high-fibre, no sugar.' },
  { emoji: '🥣', name: 'Greek Yogurt & Papaya', tag: 'Greek yogurt', cal: 240,
    ingredients: 'Greek yogurt · papaya · chia seeds',
    steps: 'Top the yogurt with chopped papaya and chia seeds. Gentle on the gut, no sugar.' },

  // ── Fruit / fibre ──
  { emoji: '🥤', name: '3-Fruit Smoothie', tag: 'Fruit', cal: 220,
    ingredients: 'Banana · berries · papaya',
  ...
  { emoji: '🥭', name: 'Mango, Banana & Chia', tag: 'Fruit', cal: 230,
    ingredients: 'Mango · banana · chia seeds',
    steps: 'Slice mango and banana, sprinkle chia seeds. Naturally sweet, no sugar.' },
];
